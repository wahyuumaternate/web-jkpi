{{-- resources/views/pendaftaran/tambah_peserta.blade.php --}}
<!DOCTYPE html>
<html lang="id">
...
<head>
    ...
    <title>Tambah Peserta — Admin Rakernas XII JKPI 2026</title>
    ...
    <style>
        ...
        * {
        ...
        /* ── ADMIN PAGE HEADER (ganti hero marketing) ────── */
        .admin-topbar {
            background: #fff;
...
<body>
        ...
        <div class="container" style="max-width:1100px;">
            ...
            <div class="admin-header-row">
                <div class="admin-header-left">
                    <span class="admin-badge"><span class="dot"></span> Panel Admin · Rakernas XII JKPI 2026</span>
                    <h1>Tambah Data Peserta</h1>
                    <p>Gunakan formulir ini untuk memasukkan data peserta baru — misalnya untuk rombongan yang
                        mendaftar secara manual atau di luar sistem registrasi online.</p>
                </div>
                ...
                <form id="registrationForm" method="POST" action="{{ route('pendaftaran.store') }}"
                    ...
                    <div id="step-form">
                        ...
                        <div class="alert alert-info mb-4">
                            ...
                            Kosongkan nama kepala daerah jika tidak hadir dan hanya wakil yang hadir.
                        </div>
                        ...
                        <div class="form-footer">
                            <div class="form-footer-note">
                                ...
                                <span>Klik <strong>Pratinjau Data</strong> untuk memeriksa kembali isian sebelum data
                                    disimpan ke sistem.</span>
                            </div>
                    ...
                    <div id="step-preview" style="display:none;">
                        ...
                        <div class="pv-header">
                            <div class="pv-header-left">
                                <h3>Periksa Data Peserta</h3>
                                <p>Pastikan seluruh informasi sudah benar sebelum disimpan ke sistem.</p>
                            </div>
                        ...
                        <div class="pv-actions">
                            ...
                            <button type="button" class="btn-pv-confirm" id="btn-pv-confirm"
                                ...
                                <i class="bi bi-send-check"></i> Konfirmasi & Simpan Data
                            </button>
                        </div>
    ...
    <script>
        ...
        function goToPreview() {
            ...
            /* Header chip */
            document.getElementById('pv-daerah-chip').textContent = namaDaerah ? `Daerah : ${namaDaerah}` :
                'Daerah : —';
            ...
            btn.disabled = false;
            btn.innerHTML = '<i class="bi bi-send-check"></i> Konfirmasi & Simpan Data';
