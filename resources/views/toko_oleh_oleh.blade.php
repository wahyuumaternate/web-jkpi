...
@section('title', 'Toko Oleh-Oleh - Rakernas XII JKPI 2026 Kota Ternate')
...
@section('content')
    ...
    <section class="oleholeh-hero">
        <div class="container">
            <div class="hero-badge"><i class="bi bi-bag-heart me-2"></i>Oleh-Oleh Kota Ternate</div>
            <h1 class="hero-title text-white">Toko Oleh-Oleh<br>Kota Ternate</h1>
            <p class="hero-subtitle">
                Daftar lengkap toko oleh-oleh di Kota Ternate
                untuk peserta Rakernas JKPI XII 2026.
            </p>
            <div class="hero-stats">
                <div class="hero-stat">
                    <span class="hero-stat-number" id="statTotal">12</span>
                    <span class="hero-stat-label">Total Toko</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="oleholeh-content">
        <div class="container">
            ...
            <div class="toolbar-card">
                <div class="toolbar-row">
                    <div class="search-box">
                        ...
                        <input type="text" id="oleholehSearch" placeholder="Cari nama toko atau alamat...">
                    </div>
                    ...
                    <div class="result-count">Menampilkan <strong id="oleholehCount">12</strong> toko</div>
                </div>
            </div>

            <!-- GRID VIEW -->
            <div class="oleholeh-grid grid-view active" id="gridView"></div>

            <!-- TABLE VIEW -->
            <div class="table-view" id="tableView">
                <div class="oleholeh-table-wrap">
                    <table class="oleholeh-table">
                        <thead>
                            <tr>
                                <th>No</th>
                                <th>Nama Usaha</th>
            ...
            <div class="no-results" id="noResults" style="display: none;">
                ...
                <p>Tidak ada toko oleh-oleh yang sesuai pencarian Anda.</p>
            </div>
        ...
        const oleholehData = [
            {
                ...
                address: [
                    { label: null, text: "Jl. Sultan M.Djabir Sjah, Kel. Gamalama" }
                ]
            },
            {
                no: 2,
                ...
                phone: ["082395762900"],
                address: [
                    { label: "Outlet 1", text: "Jl. Kapitan Pattimura, Kalumpang" },
                    { label: "Outlet 2", text: "Jl. Sultan M Djabir Sjah, Salero" },
                    { label: "Produksi", text: "Kasturian" }
                ]
            },
            {
                no: 3,
                ...
                address: [
                    { label: null, text: "Kel. Maliaro RT14/RW05" }
                ]
            },
            {
                no: 4,
                ...
                phone: ["08114314483"],
                address: [
                    { label: null, text: "Jl. Sayyid Abubakar Bin Salim Alhaddar No.09 RT03/RW03, Lingkungan Tabahawa, Kel. Salahuddin" }
                ]
            },
            {
                no: 5,
                ...
                phone: ["085241936764"],
                address: [
                    { label: null, text: "Jl. Cengkeh Afo, Kel. Marikurubu" }
                ]
            },
            {
                no: 6,
                ...
                phone: ["081342078864"],
                address: [
                    { label: null, text: "Kampung Kodok, Lingk Jl. Falajawa No.1 Muhajirin" }
                ]
            },
            {
                no: 7,
                ...
                phone: [],
                address: [
                    { label: null, text: "Jl. Nukila No.13 Gamalama" }
                ]
            },
            {
                no: 8,
                ...
                phone: ["081226104208"],
                address: [
                    { label: null, text: "Gang Habib Abubakar Al Attas, Jl. Nukila, Gamalama" }
                ]
            },
            {
                no: 9,
                ...
                phone: ["081340054052"],
                address: [
                    { label: null, text: "Jl. Balibunga, RT006/RW002, Tabona" }
                ]
            },
            {
                no: 10,
                ...
                phone: ["081343946825"],
                address: [
                    { label: null, text: "Jl. Kapitan Pattimura RT001/RW002, Lingkungan Fotododara, Kalumpang" }
                ]
            },
            {
                no: 11,
            ...
            },
            {
                ...
                phone: ["082190088770"],
                address: [
                    { label: null, text: "Jalan Pemuda, Siko Lampu Merah (Depan Jalan Raya), Sangaji" }
                ]
            }
        ];
        ...
        function render() {
            ...
            tableBody.innerHTML = filtered.map(k => {
                const phonesTable = k.phone.length > 0
                    ? k.phone.map(p => `<div class="table-oleholeh-phone"><a href="tel:${p}" style="color:var(--primary);text-decoration:none;">${p}</a></div>`).join('')
