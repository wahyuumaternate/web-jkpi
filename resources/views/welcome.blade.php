            ...
            <div class="row align-items-center" style="min-height: 90vh;">
                <div class="col-lg-12 text-center">
                    <div class="hero-content" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div data-aos="fade-up" data-aos-delay="600" style="max-width: 800px; margin: 0 auto 35px;">
                            <div
                ...
                <div class="event-tabs-container" data-aos="fade-up" data-aos-delay="300">
                    <div class="d-flex justify-content-center">
                        <ul class="nav nav-pills event-tabs mb-5" id="eventTabs" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="hari2-tab" data-bs-toggle="pill" data-bs-target="#hari2"
                                    type="button" role="tab" aria-controls="hari2" aria-selected="false">
                                    27 Agustus
                                </button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="hari3-tab" data-bs-toggle="pill" data-bs-target="#hari3"
                                    type="button" role="tab" aria-controls="hari3" aria-selected="false">
                                    28 Agustus
                                </button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="hari4-tab" data-bs-toggle="pill" data-bs-target="#hari4"
                                    type="button" role="tab" aria-controls="hari4" aria-selected="false">
                                    29 Agustus
                                </button>
                            </li>

                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="hari5-tab" data-bs-toggle="pill" data-bs-target="#hari5"
                                    type="button" role="tab" aria-controls="hari5" aria-selected="false">
                                    30 Agustus
                                </button>
                            </li>
                ...
                <div class="col-lg-12">
                    <div class="content-wrapper" style="color: #fff;">
                        ...
                        <div class="action-buttons">
                            <a href="{{ url('/dokumentasi') }}" target="_blank"
                        ...
                        <div class="stats-row mt-5"
                            ...
                            <div class="stat-item">
                                <div class="stat-number" style="font-size: 3rem; font-weight: 900; margin-bottom: 5px;">79
                                </div>
                                <div class="stat-label" style="font-size: 1.1rem; opacity: 0.9;">Kab/Kota Anggota
                                </div>
                            </div>
                            <div class="stat-item">
                                <div class="stat-number" style="font-size: 3rem; font-weight: 900; margin-bottom: 5px;">
                                    1000+</div>
