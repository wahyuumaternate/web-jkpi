...
class KontakExport implements FromCollection, WithHeadings, WithMapping, WithStyles, ShouldAutoSize, WithTitle
{
    protected $filters;
    ...
    {
        return ['NO', 'KODE REGISTRASI', 'NAMA LENGKAP', 'EMAIL', 'EMAIL VERIFIED', 'NO. TELEPON', 'NO. WHATSAPP'];
    }
